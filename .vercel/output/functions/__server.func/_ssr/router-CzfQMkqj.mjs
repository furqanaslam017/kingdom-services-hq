import { e as compileDecodeCharMap, h as createLRUCache, a3 as trimPath, a0 as rewriteBasepath, f as composeRewrites, U as processRouteTree, S as processRouteMasks, $ as resolvePath, d as cleanPath, a5 as trimPathRight, g as createControlledPromise, Q as parseHref, q as executeRewriteInput, C as isDangerousProtocol, W as redirect, I as isRedirect, G as isNotFound, u as findSingleMatch, l as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, c as buildRouteBranch, A as interpolatePath, P as nullReplaceEqualDeep, Y as replaceEqualDeep$1, M as last, k as decodePath, s as findFlatMatch, v as functionalUpdate$1, t as findRouteMatch, H as isPromise, B as invariant$1, a1 as rootRouteId, a7 as useRouter, L as jsxRuntimeExports, O as Outlet, z as hasKeys, r as executeRewriteOutput, b as arraysEqual, V as reactExports, R as React, F as isModuleNotFoundError, J as isServer$1, m as dummyMatchContext, N as matchContext, p as exactPathTest, X as removeTrailingSlash, x as getDefaultExportFromCjs, o as escapeHtml, E as isInlinableStylesheet, w as getAssetCrossOrigin, a6 as useHydrated, a4 as trimPathLeft, K as joinPaths, Z as requireReactDom, _ as resolveManifestAssetLink, n as encodePathLikeUrl } from "./server-Dgf1Fqjt.mjs";
...
const Armchair = createLucideIcon("armchair", __iconNode$b);
const __iconNode$a = [
  [
    "path",
    {
...
const PhoneCall = createLucideIcon("phone-call", __iconNode$4);
const __iconNode$3 = [
  [
    "path",
    {
...
const Recycle = createLucideIcon("recycle", __iconNode$3);
const __iconNode$2 = [
...
const SERVICES = [
  {
    ...
    title: "Junk Removal",
    icon: Trash2,
    short: "Full household or office cleanouts. We haul it all — old furniture, appliances, trash, and more.",
    description: "From a single item to a full estate cleanout, our crew handles the lifting, loading, and disposal so you don't have to. We sort for donation and recycling whenever possible.",
    includes: [
      "3-man crew + truck",
  ...
  },
  {
    ...
    title: "Moving Help",
    icon: Truck,
    short: "Apartment, storage unit, or house moves done by our 3-man expert crew with care.",
    description: "Local moves done right. We bring blankets, straps, and dollies. Apartments, storage units, and small-to-mid homes around Jackson MS.",
    includes: [
      "Loading & unloading",
  ...
  },
  {
    ...
    icon: Armchair,
    short: "Single pieces or full rooms. We disassemble, haul, and responsibly dispose.",
    description: "Old couches, mattresses, dressers, dining sets — we take them all. Tight stairwells and narrow doors are no problem for our crew.",
    includes: [
  ...
  },
  {
    ...
    icon: HardHat,
    short: "Construction debris, yard waste, concrete, and drywall. We handle the heavy stuff.",
    description: "Post-renovation cleanup, storm debris, fence demo, yard waste — we move the heavy material your trash service won't touch.",
    includes: [
  ...
  },
  {
    ...
    icon: Package,
    short: "We pack, wrap, and load your belongings safely into the truck for you.",
    description: "Already have a rental truck or pod? We provide the muscle: careful packing, wrapping, and Tetris-tight loading.",
    includes: [
      "Wrapping & padding",
  ...
  },
  {
    ...
    title: "Scrap Metal",
    icon: Recycle,
    short: "Old cars, appliances, metal scraps. We remove and recycle scrap metal responsibly.",
    description: "Appliances, water heaters, swing sets, fencing, vehicle parts — if it's metal, we recycle it the right way.",
    includes: [
      "Appliance removal",
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "header",
      {
        className: `sticky top-0 z-50 transition-all duration-300 ${scrolled ? "border-b border-border bg-background/80 backdrop-blur-xl" : "bg-background"}`,
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "mx-auto flex h-16 max-w-7xl items-center justify-between px-4 md:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-9 w-9 place-items-center rounded-xl bg-primary text-primary-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Crown, { className: "h-5 w-5" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-lg leading-none", children: "Kingdom Come" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "hidden items-center gap-8 md:flex", children: NAV.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              to: n.to,
              ...
              children: [
                n.label,
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -bottom-1 left-0 h-0.5 w-full origin-left scale-x-0 bg-primary transition-transform duration-300 group-hover:scale-x-100" })
              ]
            }
          ) }, n.to)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-7 w-7 place-items-center rounded-full bg-white/15", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PhoneCall, { className: "h-3.5 w-3.5" }) }),
                  "Free Quote"
                ]
              }
            ),
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "mt-24 border-t border-border bg-surface-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-7xl gap-12 px-6 py-16 md:grid-cols-4 md:px-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-xl leading-none", children: "Kingdom Come" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 max-w-xs text-sm leading-relaxed text-muted-foreground", children: "Junk removal & moving services in Jackson, Mississippi. 3-man crew. 4 years strong." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-semibold tracking-wide text-foreground uppercase", children: "Services" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-4 space-y-2.5 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/services", className: "link-underline transition-colors hover:text-primary", children: "Junk Removal" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/services", className: "link-underline transition-colors hover:text-primary", children: "Moving Help" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/services", className: "link-underline transition-colors hover:text-primary", children: "Furniture Removal" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/services", className: "link-underline transition-colors hover:text-primary", children: "Debris Hauling" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/services", className: "link-underline transition-colors hover:text-primary", children: "Scrap Metal" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-semibold tracking-wide text-foreground uppercase", children: "Service Area" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-4 flex flex-wrap gap-1.5 text-xs", children: [
          CITIES.slice(0, 8).map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "li",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "rounded-full border border-dashed border-primary/30 px-2.5 py-1 text-primary/70", children: "+ more" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-semibold tracking-wide text-foreground uppercase", children: "Get in touch" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-4 space-y-3 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(PhoneCall, { className: "h-4 w-4 text-primary shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: BUSINESS.phoneHref, className: "transition-colors hover:text-primary", children: BUSINESS.phone })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-4 w-4 text-primary shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: `mailto:${BUSINESS.email}`, className: "transition-colors hover:text-primary", children: BUSINESS.email })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-7xl flex-col items-center justify-between gap-2 px-6 py-6 text-xs text-muted-foreground md:flex-row md:px-10", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/privacy", className: "transition-colors hover:text-foreground", children: "Privacy" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/terms", className: "transition-colors hover:text-foreground", children: "Terms" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "·" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Licensed & insured · Jackson, MS" })
      ] })
    ] }) })
  ] });
}
const appCss = "/assets/styles-CYo3mZL2.css";
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold tracking-[0.2em] text-primary uppercase", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display mt-3 text-5xl text-foreground", children: "Page not found" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-muted-foreground", children: "The page you're looking for doesn't exist or has moved." }),
...
const Route$c = createRootRouteWithContext()(
  {
    head: () => ({
      meta: [
        ...
        {
          name: "description",
          content: "Professional junk removal, moving, furniture hauling & debris removal in Jackson, Mississippi. 3-man crew, 4 years experience, 50-mile service radius. Free estimates."
        },
...
const $$splitComponentImporter$a = () => import("./terms-CVawNy1u.mjs");
const Route$b = createFileRoute("/terms")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Terms of service for Kingdom Come Services."
    }, {
      property: "og:title",
      content: "Terms of Service — Kingdom Come Services"
    }, {
      property: "og:description",
      content: "Terms and conditions for using Kingdom Come Services."
    }],
    links: [{
      rel: "canonical",
      href: "/terms"
...
const $$splitComponentImporter$9 = () => import("./services-DxMRgEqx.mjs");
const Route$9 = createFileRoute("/services")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Junk removal, moving, furniture, debris, packing, scrap metal — Jackson MS."
    }, {
      property: "og:title",
      content: "Our Services — Kingdom Come Services"
    }, {
      property: "og:description",
      content: "Full service junk removal and moving in Jackson, MS."
    }, {
      property: "og:url",
      content: "/services"
    }],
...
const $$splitComponentImporter$8 = () => import("./privacy-DnrU-scP.mjs");
const Route$8 = createFileRoute("/privacy")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Privacy policy for Kingdom Come Services."
    }, {
      property: "og:title",
      content: "Privacy Policy — Kingdom Come Services"
    }, {
      property: "og:description",
...
const $$splitComponentImporter$7 = () => import("./pricing-qtUqQaP2.mjs");
const Route$7 = createFileRoute("/pricing")({
  head: () => ({
    meta: [{
      title: "Pricing — Kingdom Come Services"
    }, {
      name: "description",
      content: "Flat pricing for junk removal and moving in Jackson, MS. $250–300 local, distance surcharge transparent."
    }, {
      property: "og:title",
      content: "Pricing — Kingdom Come Services"
    }, {
      property: "og:description",
      content: "Clear, flat pricing. No surprises."
    }, {
      property: "og:url",
      content: "/pricing"
    }],
...
const $$splitComponentImporter$6 = () => import("./gallery-Drb7WhZf.mjs");
const Route$6 = createFileRoute("/gallery")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Photos of recent junk removal and moving jobs in Jackson, MS."
    }, {
      property: "og:title",
      content: "Gallery — Kingdom Come Services"
    }, {
      property: "og:description",
      content: "Recent work from our Jackson, MS crew."
    }, {
      property: "og:url",
      content: "/gallery"
    }],
...
const $$splitComponentImporter$5 = () => import("./contact-CN0B3Eo3.mjs");
const Route$5 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Call (601) 555-0198 or book online. Free estimates within the hour."
    }, {
      property: "og:title",
      content: "Contact Kingdom Come Services"
    }, {
      property: "og:description",
      content: "Get a free junk removal or moving estimate in Jackson, MS."
    }, {
      property: "og:url",
      content: "/contact"
    }],
...
objectType({
  customer_name: stringType().trim().min(2, "Name is required").max(100),
  phone: stringType().trim().min(7, "Phone is required").max(30),
  email: stringType().trim().email("Invalid email").max(255).optional().or(literalType("")),
  service_type: stringType().min(2),
  address: stringType().trim().min(4, "Address is required").max(255),
  preferred_date: stringType().optional(),
  time_slot: stringType().optional(),
  notes: stringType().max(1e3).optional().or(literalType(""))
});
const $$splitComponentImporter$4 = () => import("./booking-CphOO-ew.mjs");
const Route$4 = createFileRoute("/booking")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Book your junk removal or move online in Jackson, MS."
    }, {
      property: "og:title",
      content: "Book Online — Kingdom Come Services"
    }, {
      property: "og:description",
      content: "Quick online booking for junk removal and moving."
    }, {
      property: "og:url",
      content: "/booking"
    }],
...
const $$splitComponentImporter$3 = () => import("./about-BW5o2zpn.mjs");
const Route$3 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "3 locals in Jackson, MS who get things done. 4 years of junk removal and moving."
    }, {
      property: "og:title",
      content: "About Kingdom Come Services"
    }, {
      property: "og:description",
      content: "Meet the Jackson, MS crew behind Kingdom Come Services."
    }, {
      property: "og:url",
      content: "/about"
    }],
...
const $$splitComponentImporter$2 = () => import("./index-DVGLRVxr.mjs");
const Route$2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Professional junk removal and moving services in Jackson, MS. 3-man crew, 4 years experience, 50-mile service radius. Free estimates same day."
    }, {
      property: "og:title",
      content: "Kingdom Come Services — Jackson, MS"
    }, {
      property: "og:description",
      content: "Junk removal & moving help in Jackson, MS. Free estimates, same-day service."
    }, {
      property: "og:url",
      content: "/"
    }],
...
const $$splitComponentImporter$1 = () => import("./index-B6VfrrOU.mjs");
...
const $$splitComponentImporter = () => import("./login-dlpMpNWm.mjs");
...
const PricingRoute = Route$7.update({
  id: "/pricing",
  path: "/pricing",
  getParentRoute: () => Route$c
});
...
export {
  ...
  Armchair as a,
  timeUntilStale as a0,
  timeoutManager as a1,
  toast as a2,
  useConstant as a3,
  useIsomorphicLayoutEffect as a4,
  useNavigate as a5,
  useQueryClient as a6,
  velocityPerSecond as a7,
  Crown as b,
  MapPin as c,
  Menu as d,
  MotionConfigContext as e,
  PhoneCall as f,
  Subscribable as g,
  Trash2 as h,
  Truck as i,
