import { L as jsxRuntimeExports, a7 as useRouter, V as reactExports, I as isRedirect, R as React } from "./server-Dgf1Fqjt.mjs";
import { u as useMutation, C as Clock } from "./createSsrRpc-CLR5Oyub.mjs";
import { S as SERVICES, T as TIME_SLOTS, f as PhoneCall, B as BUSINESS, M as Mail, c as MapPin, a2 as toast } from "./router-CzfQMkqj.mjs";
...
function ContactPage() {
  ...
  const m = useMutation({
    mutationFn: (data) => submit({
      data
    }),
    onSuccess: (r2) => {
      toast.success(`Request received! Reference: ${r2.booking_ref}`, {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden px-6 pt-20 pb-24 md:px-10 md:pt-28", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mx-auto max-w-3xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { eyebrow: "Contact", title: "Get your", italic: "free estimate" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto mt-16 grid max-w-6xl gap-10 lg:grid-cols-[1.4fr_1fr]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit((d) => m.mutate(d)), className: "glass-card rounded-3xl p-8 md:p-10 shadow-elegant", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-5 md:grid-cols-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Full name *", error: errors.customer_name?.message, children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { ...register("customer_name"), className: inputCls, placeholder: "Jane Smith" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Phone *", error: errors.phone?.message, children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { ...register("phone"), className: inputCls, placeholder: "(601) 555-0198" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Email", error: errors.email?.message, children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { ...register("email"), type: "email", className: inputCls, placeholder: "you@example.com" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Service *", children: /* @__PURE__ */ jsxRuntimeExports.jsx("select", { ...register("service_type"), className: inputCls, children: SERVICES.map((s2) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: s2.title }, s2.slug)) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Service address *", error: errors.address?.message, children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { ...register("address"), className: inputCls, placeholder: "123 Main St, Jackson, MS" }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Preferred date", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { ...register("preferred_date"), type: "date", className: inputCls }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Preferred time", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { ...register("time_slot"), className: inputCls, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "Any time" }),
            TIME_SLOTS.map((t2) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: t2.value, children: t2.label }, t2.value))
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Notes", children: /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { ...register("notes"), rows: 4, className: `${inputCls} resize-none`, placeholder: "Tell us what needs hauling or moving..." }) }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", disabled: m.isPending, className: "mt-8 w-full rounded-full bg-primary py-3.5 text-sm font-semibold text-primary-foreground shadow-lg shadow-primary/20 transition-all hover:bg-primary-dark hover:shadow-xl disabled:opacity-60", children: m.isPending ? "Sending..." : "Send my request" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl border border-border bg-surface p-6 shadow-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl", children: "Reach us" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl bg-primary p-6 text-primary-foreground shadow-lg shadow-primary/20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl", children: "Need it today?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-white/80", children: "Call us — we often have same-day availability." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: BUSINESS.phoneHref, className: "mt-4 inline-flex items-center gap-2 rounded-full bg-white px-5 py-2.5 text-sm font-semibold text-primary shadow-md transition-all hover:bg-white/90 hover:shadow-lg", children: [
...
const inputCls = "w-full rounded-xl border border-border bg-background px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground/60 transition focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20";
function Field({
  label,
  error,
  children
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mb-1.5 block text-xs font-semibold text-foreground/70", children: label }),
    children,
