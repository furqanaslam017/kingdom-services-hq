...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C1lkm9Wb.mjs");
...
const manifest = {
  "4ced895525f4d44d99fd1ed940c1ff3677d98cc2334551a579fa5fe047b84d7d": {
    functionName: "submitBooking_createServerFn_handler",
    importer: () => import("./booking.functions-BZwGcn88.mjs")
  },
  "8bb6fc0a07bd5ded83f0f5c34ac77101e31e16438ffe62bc9269f309e95bc551": {
    functionName: "updateBookingStatus_createServerFn_handler",
    importer: () => import("./admin.functions-dE8KSiT_.mjs")
  },
  "d685d2fcea75688912a3d59887bf007ff20d21e8cb9f2ef10ed4fac47f0900f5": {
    functionName: "getBookings_createServerFn_handler",
    importer: () => import("./admin.functions-dE8KSiT_.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CzfQMkqj.mjs").then((n2) => n2.W),
    import("./start-DJGa_19-.mjs"),
