      ...
      <div className="relative mx-auto max-w-3xl">
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="font-display mt-3 text-4xl text-foreground">
            Book in{" "}
            <span className="italic text-primary">minutes</span>
          </h1>
  ...
  return (
    ...
    >
      ...
      <p className="mt-1 text-sm text-muted-foreground">
        Choose the service that best fits your job.
      </p>
...
function Step1Details({
  ...
  return (
    ...
    >
      ...
      <p className="mt-1 text-sm text-muted-foreground">
        We use this to confirm your booking and send reminders.
      </p>
...
function Step2Schedule({
  ...
  return (
    ...
    >
      ...
      <p className="mt-1 text-sm text-muted-foreground">
        Tell us where and when you need us.
      </p>
      ...
      <div className="mt-6 space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full rounded-xl border border-border bg-background px-4 py-3 text-sm text-foreground transition focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
            placeholder="Access info, gate code, item list, etc."
          />
        </div>
      </div>
    </motion.div>
    ...
    >
      ...
      <div className="mt-6 space-y-3">
        <ReviewRow
          ...
          label="Service"
          value={selected?.title ?? form.service}
        />
        <ReviewRow
        ...
        {form.preferred_date && (
          <ReviewRow
            ...
            label="Date"
            value={new Date(form.preferred_date).toLocaleDateString(undefined, {
              weekday: "short",
              month: "short",
              day: "numeric",
            })}
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        We’ll text you shortly to confirm your slot.
      </p>
      ...
      {refCode && (
        <div className="mx-auto mt-6 inline-flex items-center gap-2 rounded-full border border-border bg-surface px-4 py-2">
          ...
          <button
            onClick={copyRef}
            className="ml-1 rounded-full p-1 transition hover:bg-muted"
      ...
      <div className="mt-8">
        <Link
          to="/"
          className="inline-flex rounded-full bg-primary px-6 py-2.5 text-sm font-semibold text-primary-foreground shadow-lg shadow-primary/20 transition-all hover:bg-primary-dark hover:shadow-xl"
        >
          Back to home
        </Link>
      </div>
