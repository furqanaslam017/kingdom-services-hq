...
export default function TruckSVG({ width = '100%', className = '', animate = true }: TruckSVGProps) {
  return (
    <svg
      viewBox="0 0 600 340"
